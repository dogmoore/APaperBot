module.exports = {
    ...
    discription: 'Labels all known commands based on permission level',
	...
	const { host, port, user, password, database, charset } = require('../database-info.json');
	...
	const results = result;
        ...
        else if (message.author.id === `${GuildOwner2}`) {
